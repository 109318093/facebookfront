        ...
        <div>
            ...
            <div className="m-2 flex -space-x-px items-center justify-center">
                ...
                {data.map((x,y) => (
                    y<data.length/10 ? (
                        currPage == y+1 ? (
                            <button className="list-none text-sm w-[2rem] h-[2rem] bg-slate-600 border border-slate-600 flex items-center justify-center text-white" onClick={() => getData(y+1)}>{y+1}</button>
                        ) : <button className="list-none text-sm w-[2rem] h-[2rem] bg-slate-800 border border-slate-600 flex items-center justify-center hover:bg-slate-600 text-slate-400 hover:text-white" onClick={() => getData(y+1)}>{y+1}</button>
